...
def main ():
    ...
    #--------------------------------------------------#
    ans1 = input('Do you want to store the output? (YES/NO):\t')
    if ans1=='YES':
    ...
    ans2 = input('Do you want a plot? (YES/NO):\t') 
    while ans2=='YES':
        query1 = input('On x-axis (radius/mass/yR):\t')
        query2 = input('On y-axis (radius/mass/yR):\t')
        query3 = input('Which marker (line/dot/dash):\t')
        fname2 = input('File name for the saved plot:\t')
        ...
        plotting(x, y, marker, xname, yname, fname2, fname2)
        ans2 = input('Do you want another plot? (YES/NO):\t')    
    
    answer = input('Do you want to use another EoS (YES/NO):\t')
    while answer=='YES':
        main()
